...
public interface IParkingService
{
    ...
    Task<ReservationResponse> CreateProviderReservationAsync(
        Guid providerUserId, CreateProviderBookingRequest request, CancellationToken ct = default);
    Task<ReservationResponse> UpdateProviderReservationAsync(
        Guid providerUserId, Guid reservationId, UpdateProviderBookingRequest request,
        CancellationToken ct = default);
    Task<ReservationResponse> TransitionProviderBookingAsync(
