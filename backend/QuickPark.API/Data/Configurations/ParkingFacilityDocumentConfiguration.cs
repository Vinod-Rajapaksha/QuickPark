...
public class ParkingFacilityDocumentConfiguration : IEntityTypeConfiguration<ParkingFacilityDocument>
{
    public void Configure(EntityTypeBuilder<ParkingFacilityDocument> builder)
    {
        ...
        builder.Property(d => d.ProviderName).IsRequired().HasMaxLength(150);
        builder.Property(d => d.ProviderEmail).IsRequired().HasMaxLength(256);
        builder.Property(d => d.ProviderBusinessName).HasMaxLength(150);
